...
@endsection
@section('titre')
<form name="frm" action="{{route('stg')}}"   method="POST">
                         @method("get")
                         @csrf        
...
<div style="height: 550px;">
  ...
  <li class="nav-item">
    <a class="nav-link " aria-current="page" href="#">Tous Les Stagiaires</a>
  </li>
  
  <li class="nav-item">
    <a class="nav-link" href="#">Diplome & Bac</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#">Diplome</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item dropdown">
        ...
        <a class="dropdown-item" href=""> Liste des Admin </a>
